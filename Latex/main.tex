...
De la teoría el único modelo de suavizado que debería ajustarse es el suavizado Holt-Winters debido a que existe componente estacional. No obstante, como computacionalmente no es costoso, se ajustan todos los suavizados para ver cuales es razonable estudiar en la validación. Los resultados de las predicciones se pueden ver en la figura \ref{fig:comparacion_modelos}.
	...
	\begin{longtable}{lrrr}
		...
		\caption{Resultados de los tests de hipótesis realizados en los modelos SARIMA. En rojo se marcan aquellos p-valores con significancia menor a \(0.01\), en verde aquellos con significancia mayor a \(0.05\) y en amarillo el resto. } \label{tab:resultados}\\
		\toprule
		...
		$(2,0,0)(2,1,0)_{[12]}$& \cellcolor{green!30}{\textcolor{black}{0.1683}} & \cellcolor{green!30}{\textcolor{black}{0.6077}} & \cellcolor{red!30}{\textcolor{black}{0.0033}}\\
	...
	\caption{Resultados de los tests de hipótesis realizados en los modelos SARIMA junto a su error. En rojo se marcan aquellos p-valores con significancia menor a \(0.01\), en verde aquellos con significancia mayor a \(0.05\) y en amarillo el resto.} 
	...
	$(2,0,0)(2,1,0)_{[12]}$ & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.4424 & 3.7190\\
...
\begin{table}[H]
	...
	\begin{tabular}{llcc}
		...
		\nabla_s^1X_t $& 3.5523 & 3.5725\\
		&$= \epsilon_t$ &&\\
		\midrule
		$(1,0,1)(1,1,0)$ & $(1 - 0.9086B^1)(1 + 0.4894B^{1s})
		\nabla_s^1X_t $& 3.4807 & 3.6146\\
		&$= (1 + 0.6426B^1)\varepsilon_t$&& \\
		\midrule
