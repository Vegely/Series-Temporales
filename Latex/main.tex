...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\textwidth]{grafica_serie_2.pdf}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\linewidth]{grafica_outliers_1}
		\caption{Representación de los posibles valores atípicos en el conjunto de entrenamiento.}
		\label{fig:graficaoutliers1}
	\end{figure}

\newpage
Por último, el análisis exploratorio de los datos indica que se debe realizar una única {diferenciación estacional} y ninguna diferenciación regular. Para comprobar que, efectivamente, la serie ha sido desestacionalizada y es adecuada para el modelado, se realiza el Test de Dickey-Fuller donde se obtiene el siguiente resultado:
\begin{equation}
	\text{p-valor} = 0.02345 < \alpha = 0.05
\end{equation}

Dado que el p-valor es menor que el nivel de significación, rechazamos la hipótesis nula, lo que indica que la serie transformada es \textbf{estacionaria}.
...
De la teoría el único modelo de suavizado que debería ajustarse es el suavizado Holt-Winters debido a que existe componente estacional. No obstante, como computacionalmente no es costoso, se ajustan todos los suavizados para ver cuales es razonable estudiar en la validación. Los resultados de las predicciones se pueden ver en la figura \ref{fig:comparacion_modelos}.
	...
	Tal como se mencionó en la metodología una vez ajustado un modelo SARIMA inicial se realiza un barrido en todos los posibles modelos que tengan las mismas diferenciaciones para escoger aquel que tenga menor error con el conjunto de validación y que a su vez cumpla los tests de: independencia, homocedasticidad y normalidad. En la tabla \ref{tab:resultados} se pueden ver los resultados de ejecución y como ningún modelo cumple normalidad si se selecciona $\alpha=0.05$. No obstante, las celdas en amarillo se encuentran en la zona de significancia marginal (p-valor entre 0.01 y 0.05). Si la normalidad de un modelo se encuentra en la misma y se cumplen además las hipótesis de independencia y homocedasticidad, será considerado válido.
	\begin{longtable}{lrrr}
		...
		\caption{Resultados de los tests de hipótesis realizados en los modelos SARIMA. En rojo se marcan aquellos p-valores con significancia menor a \(0.01\), en verde aquellos con significancia mayor a \(0.05\) y en amarillo el resto. Además, se marca en azul el modelo inicial estimado.} \label{tab:resultados}\\
		\toprule
		...
		% ---------------------------------------------------------
		\((0,0,0)(0,1,1)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0000}} & \cellcolor{green!30}{\textcolor{black}{0.1672}} & \cellcolor{red!30}{\textcolor{black}{0.0006}}\\
		\((0,0,0)(1,1,0)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0000}} & \cellcolor{green!30}{\textcolor{black}{0.2488}} & \cellcolor{red!30}{\textcolor{black}{0.0058}}\\
		\((0,0,0)(2,1,3)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0000}} & \cellcolor{green!30}{\textcolor{black}{0.1369}} & \cellcolor{red!30}{\textcolor{black}{0.0017}}\\
		\((0,0,1)(0,1,0)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0000}} & \cellcolor{green!30}{\textcolor{black}{0.4620}} & \cellcolor{yellow!30}{\textcolor{black}{0.0301}}\\
		\((0,0,1)(0,1,1)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0001}} & \cellcolor{green!30}{\textcolor{black}{0.5475}} & \cellcolor{red!30}{\textcolor{black}{0.0006}}\\
		\((0,0,1)(1,1,0)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0000}} & \cellcolor{green!30}{\textcolor{black}{0.7799}} & \cellcolor{red!30}{\textcolor{black}{0.0052}}\\
		\((0,0,1)(2,1,0)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0001}} & \cellcolor{green!30}{\textcolor{black}{0.7007}} & \cellcolor{red!30}{\textcolor{black}{0.0005}}\\
		\((0,0,2)(0,1,0)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0000}} & \cellcolor{green!30}{\textcolor{black}{0.6523}} & \cellcolor{red!30}{\textcolor{black}{0.0017}}\\
		\((0,0,2)(0,1,1)_{[12]}\) & \cellcolor{yellow!30}{\textcolor{black}{0.0152}} & \cellcolor{green!30}{\textcolor{black}{0.7426}} & \cellcolor{red!30}{\textcolor{black}{0.0010}}\\
		\((0,0,2)(1,1,0)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0030}} & \cellcolor{green!30}{\textcolor{black}{0.9804}} & \cellcolor{yellow!30}{\textcolor{black}{0.0144}}\\
		\((0,0,2)(2,1,0)_{[12]}\) & \cellcolor{yellow!30}{\textcolor{black}{0.0143}} & \cellcolor{green!30}{\textcolor{black}{0.9332}} & \cellcolor{red!30}{\textcolor{black}{0.0075}}\\
		\((0,0,3)(0,1,1)_{[12]} \)& \cellcolor{green!30}{\textcolor{black}{0.0794}} & \cellcolor{green!30}{\textcolor{black}{0.8809}} & \cellcolor{red!30}{\textcolor{black}{0.0036}}\\
		\((0,0,3)(2,1,0)_{[12]}\) & \cellcolor{green!30}{\textcolor{black}{0.0746}} & \cellcolor{green!30}{\textcolor{black}{0.9121}} & \cellcolor{red!30}{\textcolor{black}{0.0013}}\\
		\((1,0,0)(0,1,0)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0000}} & \cellcolor{green!30}{\textcolor{black}{0.7017}} & \cellcolor{red!30}{\textcolor{black}{0.0058}}\\
		\((1,0,0)(0,1,1)_{[12]}\) & \cellcolor{yellow!30}{\textcolor{black}{0.0122}} & \cellcolor{green!30}{\textcolor{black}{0.8926}} & \cellcolor{red!30}{\textcolor{black}{0.0028}}\\
		\((1,0,0)(1,1,0)_{[12]} \)& \cellcolor{red!30}{\textcolor{black}{0.0004}} & \cellcolor{green!30}{\textcolor{black}{0.6947}} & \cellcolor{red!30}{\textcolor{black}{0.0017}}\\
		\((1,0,0)(2,1,0)_{[12]}\) & \cellcolor{green!30}{\textcolor{black}{0.0504}} & \cellcolor{green!30}{\textcolor{black}{0.7125}} & \cellcolor{red!30}{\textcolor{black}{0.0026}}\\
		\((1,0,1)(0,1,0)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0001}} & \cellcolor{green!30}{\textcolor{black}{0.9166}} & \cellcolor{red!30}{\textcolor{black}{0.0007}}\\
		\((1,0,1)(0,1,1)_{[12]}\) & \cellcolor{green!30}{\textcolor{black}{0.3251}} & \cellcolor{green!30}{\textcolor{black}{0.8681}} & \cellcolor{red!30}{\textcolor{black}{0.0026}}\\
		\((1,0,1)(1,1,0)_{[12]}\) & \cellcolor{green!30}{\textcolor{black}{0.1118}} & \cellcolor{green!30}{\textcolor{black}{0.6236}} & \cellcolor{yellow!30}{\textcolor{black}{0.0139}}\\
		\((1,0,1)(2,1,0)_{[12]}\) & \cellcolor{green!30}{\textcolor{black}{0.6094}} & \cellcolor{green!30}{\textcolor{black}{0.6972}} & \cellcolor{red!30}{\textcolor{black}{0.0075}}\\
		\((2,0,0)(0,1,0)_{[12]}\) & \cellcolor{red!30}{\textcolor{black}{0.0000}} & \cellcolor{green!30}{\textcolor{black}{0.9473}} & \cellcolor{red!30}{\textcolor{black}{0.0002}}\\
		\((2,0,0)(0,1,1)_{[12]}\) & \cellcolor{yellow!30}{\textcolor{black}{0.0485}} & \cellcolor{green!30}{\textcolor{black}{0.7601}} & \cellcolor{red!30}{\textcolor{black}{0.0082}}\\
		\((2,0,0)(1,1,0)_{[12]}\) & \cellcolor{green!30}{\textcolor{black}{0.0562}} & \cellcolor{green!30}{\textcolor{black}{0.5643}} & \cellcolor{yellow!30}{\textcolor{black}{0.0101}}\\
		$\cellcolor{blue!60!cyan!30}(2,0,0)(2,1,0)_{[12]}$& \cellcolor{green!30}{\textcolor{black}{0.1683}} & \cellcolor{green!30}{\textcolor{black}{0.6077}} & \cellcolor{red!30}{\textcolor{black}{0.0033}}\\
		\((2,0,1)(2,1,3)_{[12]}\) & \cellcolor{yellow!30}{\textcolor{black}{0.0382}} & \cellcolor{green!30}{\textcolor{black}{0.8533}} & \cellcolor{red!30}{\textcolor{black}{0.0041}}\\
		\((3,0,0)(0,1,1)_{[12]}\) & \cellcolor{yellow!30}{\textcolor{black}{0.0264}} & \cellcolor{green!30}{\textcolor{black}{0.6382}} & \cellcolor{yellow!30}{\textcolor{black}{0.0126}}\\
		\((3,0,0)(2,1,0)_{[12]}\) & \cellcolor{green!30}{\textcolor{black}{0.1897}} & \cellcolor{green!30}{\textcolor{black}{0.5170}} & \cellcolor{yellow!30}{\textcolor{black}{0.0297}}\\
		\((3,0,0)(2,1,3)_{[12]}\) & \cellcolor{yellow!30}{\textcolor{black}{0.0271}} & \cellcolor{green!30}{\textcolor{black}{0.5754}} & \cellcolor{yellow!30}{\textcolor{black}{0.0314}}\\
		\((3,0,2)(2,1,0)_{[12]}\) & \cellcolor{green!30}{\textcolor{black}{0.4104}} & \cellcolor{green!30}{\textcolor{black}{0.6916}} & \cellcolor{yellow!30}{\textcolor{black}{0.0172}}\\
		
	\end{longtable}
	
	A continuación, en la tabla \ref{tab:resultados2} se recogen los valores del error cuadrático medio de los distintos modelos candidatos. Entre estos, solo 4 candidatos cumplen todas las hipótesis (normalidad relajada) y se seleccionan en magenta aquellos con menor valor del error.



	\begin{longtable}{lccccc}
	
	\caption{Resultados de los tests de hipótesis realizados en los modelos SARIMA junto a su error. En rojo se marcan aquellos p-valores con significancia menor a \(0.01\), en verde aquellos con significancia mayor a \(0.05\) y en amarillo el resto. Además, se marca en azul el modelo inicial estimado y en magenta los modelos propuestos.} 
	...
	$(0,0,0)(0,1,1)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 4.0531 & 3.5227\\
	$(0,0,0)(1,1,0)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 4.1000 & 3.2865\\
	$(0,0,0)(2,1,3)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.9201 & 3.5917\\
	$(0,0,1)(0,1,0)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{yellow!30}{NO} & 4.2458 & 3.5412\\
	$(0,0,1)(0,1,1)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.7374 & 3.8851\\
	$(0,0,1)(1,1,0)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.8509 & 3.3284\\
	$(0,0,1)(2,1,0)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.7432 & 3.5380\\
	$(0,0,2)(0,1,0)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 4.1365 & 3.6381\\
	$(0,0,2)(0,1,1)_{[12]}$ & \cellcolor{yellow!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.5665 & 4.1563\\
	$(0,0,2)(1,1,0)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{yellow!30}{NO} & 3.6802 & 3.4406\\
	$(0,0,2)(2,1,0)_{[12]}$ & \cellcolor{yellow!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.6035 & 3.5702\\
	$(0,0,3)(0,1,1)_{[12]}$ & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.5081 & 4.2694\\
	$(0,0,3)(2,1,0)_{[12]}$ & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.5580 & 3.5936\\
	$(1,0,0)(0,1,0)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 4.1648 & 3.6213\\
	$(1,0,0)(0,1,1)_{[12]}$ & \cellcolor{yellow!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.4760 & 4.7911\\
	$(1,0,0)(1,1,0)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.6973 & 3.4407\\
	$(1,0,0)(2,1,0)_{[12]}$ & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.5537 & 3.7018\\
	$(1,0,1)(0,1,0)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.9917 & 4.1054\\
	$(1,0,1)(0,1,1)_{[12]}$ & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.0437 & 4.0382\\
	\cellcolor{magenta!30}{$(1,0,1)(1,1,0)_{[12]}$} & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{yellow!30}{NO} & 3.4807 & 3.6146\\
	$(1,0,1)(2,1,0)_{[12]}$ & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.3184 & 3.7311\\
	$(2,0,0)(0,1,0)_{[12]}$ & \cellcolor{red!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 4.0448 & 3.8182\\
	$(2,0,0)(0,1,1)_{[12]}$ & \cellcolor{yellow!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.3101 & 5.1379\\
	\cellcolor{magenta!30}{$(2,0,0)(1,1,0)_{[12]}$} & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{yellow!30}{NO} & 3.5523 & 3.5725\\
	$\cellcolor{blue!60!cyan!30}(2,0,0)(2,1,0)_{[12]}$ & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.4424 & 3.7190\\
	$(2,0,1)(2,1,3)_{[12]}$ & \cellcolor{yellow!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{red!30}{NO} & 3.1133 & 5.5767\\
	$(3,0,0)(0,1,1)_{[12]}$ & \cellcolor{yellow!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{yellow!30}{NO} & 3.2204 & 5.3714\\
	$(3,0,0)(2,1,0)_{[12]}$ & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{yellow!30}{NO} & 3.3924 & 3.7661\\
	$(3,0,0)(2,1,3)_{[12]}$ & \cellcolor{yellow!30}{NO} & \cellcolor{green!30}{SÍ} & \cellcolor{yellow!30}{NO} & 2.9320 & 6.4224\\
	\cellcolor{magenta!30}{$(3,0,2)(2,1,0)_{[12]}$} & \cellcolor{green!30}{SÍ} & \cellcolor{green!30}{SÍ} & \cellcolor{yellow!30}{NO} & 3.3215 & 3.7474\\
...
\begin{table}[H]
	...
	\begin{tabular}{llcc}
		...
		\midrule
		$(2,0,0)(1,1,0)$ & $(1 - 0.3201B^1 - 0.2784B^2)(1 + 0.4758B^{1s})
		\nabla_s^1X_t $&&\\
		&$= \epsilon_t$ & 3.5523 & 3.5725\\
		\midrule
		$(1,0,1)(1,1,0)$ & $(1 - 0.9086B^1)(1 + 0.4894B^{1s})
		\nabla_s^1X_t $&&\\
		&$= (1 + 0.6426B^1)\varepsilon_t$ & 3.4807 & 3.6146\\
		\midrule
		$(3,0,2)(2,1,0)$ & $(1 - 0.1276B^1 - 0.6914B^2 - 0.0362B^3)\cdot$& 3.3215 & 3.7474\\
		&$(1 + 0.6231B^{1s} + 0.2932B^{2s})\nabla_s^1X_t$&& \\
		&$= (1 - 0.1395B^1 + 0.4984B^2)\varepsilon_t$&& \\
		\bottomrule
	\end{tabular}
...
\newpage
	\section{Discusión}
	Una vez obtenidos los resultados anteriores se entrenan ahora 4 modelos predictivos, uno basado en el suavizado de Holt-Winters y otros 3 basados en modelos ARIMA. Pues como se puede ver si se comparan las tablas \ref{tab:alis} y \ref{taB:arimaFInal} el modelo determinista mediante suavizados tiene una mejor generalización y ajusta mejor nuevos datos.
	\newline
	
	No obstante, tal y como se vio en la figura \ref{fig:SerieTRans} los modelos cometen un gran error al principio del entrenamiento y posiblemente si se tomasen los datos a partir de 2012 los modelos ARIMA mejorarían significativamente.
	\newline
	
	Por último, como el objetivo es predecir se reentrenan todos los modelos con todos los datos de la serie, es decir, se juntan los conjuntos de entrenamiento y validación en uno solo porque para una predicción a futuro los más relevante son los datos más recientes. En la figura \ref{fig:4forecast} se recogen las predicciones de estos 4 modelos.
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\caption{SARIMA $(1,0,1)(1,1,0)_{[12]}$}
			\label{fig:pred_b}
		\end{subfigure}
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\caption{SARIMA $(2,0,0)(1,1,0)_{[12]}$}
			\label{fig:pred_c}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\caption{SARIMA $(3,0,2)(2,1,0)_{[12]}$}
			\label{fig:pred_d}
		\end{subfigure}
...
\newpage
	...
	El análisis de la serie temporal de las concentraciones de \(NO_2\) en la estación de Cuatro Caminos ha permitido caracterizar la dinámica de la contaminación urbana y evaluar la eficacia de distintas herramientas de predicción. A partir de los resultados obtenidos y la discusión planteada, se extraen las siguientes conclusiones principales:
	
	\begin{itemize}
		\item \textbf{Dinámica de la serie y preprocesamiento:} El análisis exploratorio confirmó un periodo estacional mensual ($s=12$) y una tendencia decreciente a largo plazo, consistente con la implementación de políticas de reducción de emisiones en la última década. Asimismo, se identificó la naturaleza heterocedástica de los datos, requiriendo una transformación de Box-Cox ($\lambda \approx 0.8$) y una diferenciación estacional ($D=1$) para garantizar la estacionariedad, confirmada posteriormente mediante el test de Dickey-Fuller.
		...
		\item \textbf{Limitaciones de los modelos SARIMA:} Si bien se identificaron modelos estadísticamente significativos, estos presentaron dificultades para cumplir estrictamente con la hipótesis de normalidad en los residuos (Test de Kolmogorov-Smirnov). Esto sugiere que la serie contiene dinámicas no lineales o valores atípicos puntuales que la estructura lineal de los modelos ARIMA no logra capturar en su totalidad.
		
		\item \textbf{Impacto de la volatilidad histórica:} Se observó un fenómeno particular donde el error de entrenamiento fue sistemáticamente superior al de validación en el caso concreto de Holt-Winters. Esto evidencia que el comportamiento del contaminante antes de 2012 presentaba una variabilidad y unos niveles medios mucho más erráticos que en la actualidad. 
	\end{itemize}
	
	Como líneas de trabajo futuro, se propone acotar el rango histórico de entrenamiento (por ejemplo, utilizando datos únicamente a partir de 2012) para reducir el ruido estructural y mejorar el ajuste de los modelos estocásticos. Asimismo, sería pertinente explorar modelos multivariantes (ARIMAX) que incorporen variables exógenas meteorológicas, o técnicas de aprendizaje profundo (Redes LSTM) capaces de modelar las no linealidades detectadas en los residuos.
